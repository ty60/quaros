...
kernel_objs := start.o main.o memory.o util.o segment.o lapic.o uart.o io.o string.o ioapic.o int_common.o context_switch.o vectors.o interrupt.o fs.o proc.o
kernel_ld := kernel.ld
